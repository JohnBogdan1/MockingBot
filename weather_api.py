...
class MyWeather(object):
    ...
    def compose_weather_status(self):
        weather = self.get_weather_by_city()
        return f'In {self.translator.translate(self.city)} este {self.translator.translate(weather.detailed_status)}, iar temperatura ' \
